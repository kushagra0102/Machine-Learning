...
x1x2 = np.array([X[:,0]*X[:,1]])
x1square = np.array([X[:,0]**2])
x2square = np.array([X[:,1]**2])
x1cube = np.array([X[:,0]**3])
x2cube = np.array([X[:,1]**3])

X = np.append(X, x1x2.T,axis=1)
X = np.append(X, x1square.T,axis=1)
X = np.append(X, x2square.T,axis=1)
X = np.append(X, x1cube.T,axis=1)
X = np.append(X, x2cube.T,axis=1)
